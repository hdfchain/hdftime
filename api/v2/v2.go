...
const (
	...
	// server.
	DefaultMainnetTimeHost = "time.clkj.ltd"
	...
	// server.
	DefaultTestnetTimeHost = "time-testnet.clkj.ltd"
...
var (
	...
	// the account balance from hdftimed's wallet instance
...
type VersionReply struct {
	Versions      []uint   `json:"versions"` // hdftime API supported versions.
