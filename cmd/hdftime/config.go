...
const (
	defaultConfigFilename = "hdftime.conf"
)

var (
	defaultHomeDir    = cleanAndExpandPath(dcrutil.AppDataDir("hdftime", false))
	defaultConfigFile = filepath.Join(defaultHomeDir, defaultConfigFilename)
)

// config defines the configuration options for hdftime.
//
