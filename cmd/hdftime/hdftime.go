...
import (
	...
	v2 "github.com/hdfchain/hdftime/api/v2"
	"github.com/hdfchain/hdftime/merkle"
	"github.com/hdfchain/hdftime/util"
)

const (
	hdftimeClientID = "hdftime cli"
)
...
// showWalletBalanceV1 returns the total balance of the primary hdftimed wallet,
// in atoms.
func showWalletBalanceV1() error {
	...
	// Decode the response from hdftimed
...
// showWalletBalanceV2 returns the total balance of the primary hdftimed wallet,
// in atoms.
