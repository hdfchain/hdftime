...
[![Build Status](https://github.com/hdfchain/hdftime/workflows/Build%20and%20Test/badge.svg)](https://github.com/hdfchain/hdftime/actions)
[![ISC License](https://img.shields.io/badge/license-ISC-blue.svg)](http://copyfree.org)
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/hdfchain/hdftime)

Decred anchored timestamp client and server.

The hdftime stack as as follows:
...
## Components
* hdftime - Reference client application
* hdftimed
	- Proxy Mode: Forwards requests to the backend server.
	- Backend mode: Manages timestamps and creates hdfchain transaction that anchors transactions in the blockchain.

## Library and interfaces
* api/v1 - JSON REST API for hdftime clients.
* cmd/hdftime - Client reference implementation.
* cmd/hdftime_dump - Data dump/restore tool for filesystem based backend.
* cmd/hdftime_fsck - Data integrity tool for filesystem based backend.
* cmd/hdftime_unflush - Debug backend tool to either delete the flush record or reset the chain timestamp.
* cmd/hdftime_timestamp - Tool to convert between various timestamp formats.
...
This example hdftimed.conf connects to dcrwallet running on localhost using the testnet network.
...
07:36:09 2017-06-09 [INF] DCRT: Home dir: /home/user/.hdftimed
...
hdftimed also has a proxy mode.  It is activated by specifying the --storehost and --storecert options.
...
```
proxy-server$ mkdir ~/.hdftimed
proxy-server$ scp storehost.example.com:/home/user/.hdftimed/https.cert ~/.hdftimed/hdftimed.cert
proxy-server$ hdftimed --testnet --storehost=storehost.example.com --storecert=~/.hdftimed/hdftimed.cert
07:50:59 2017-06-09 [WRN] DCRT: open /home/user/.hdftimed/hdftimed.conf: no such file or directory
...
07:50:59 2017-06-09 [INF] DCRT: Home dir: /home/user/.hdftimed
...
```
$ hdftime -v b1d080f4d09ea21a7b1872d87993079a84718f485de87d0327b6d1da922620e1
...
```
$ hdftime -v 8496855341883fdc90cc532f8304d1c46a60586fb15d99f07e41bb5ab19c79c6
...
You can find the merkle root using block explorer.  Surf to https://testnet.clkj.ltd/tx/554b27c309ac9a8dab8ae261bb13dcfcdd351aa5f196322c112f04d106e000f3 and in the transaction you'll find an entry that is as follows:
```
OP_RETURN 9788d5d7b85f2b68ec21d26e738dce6cdd367ee0ec58b53ad6bd4d46b0bc3018
```
The astute reader noticed that this is the Merkle Root the hdftime client returned.

Note that this example was run on a single machine but that the listen port bits were removed for clarity.

## License

hdftime is licensed under the [copyfree](http://copyfree.org) ISC License.
